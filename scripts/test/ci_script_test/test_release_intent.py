...
class TestLoadIntentFile:
    ...
    def test_load_valid_intent_file(self) -> None:
        ...
        valid_intent = {
            "release": True,
            "level": "minor",
            "artifacts": {"python": "auto", "docker": "force", "docs": "auto"},
            "notes": "Test release",
        }
...
class TestMergeIntentData:
    ...
    def test_merge_with_file_data(self) -> None:
        ...
        file_data = {
            "release": False,
            "level": "major",
            "artifacts": {"python": "skip", "docker": "force"},
            "notes": "File notes",
        }
        workflow_inputs = {
            "level": "",
    ...
    def test_merge_with_workflow_inputs(self) -> None:
        ...
        defaults = get_defaults()
        file_data = {"level": "minor", "artifacts": {"python": "auto", "docker": "skip"}, "notes": "File notes"}
        workflow_inputs = {
            "level": "patch",
            "python": "force",
            "docker": "",
    ...
    def test_merge_complete_override(self) -> None:
        ...
        file_data = {
            "release": False,
            "level": "minor",
            "artifacts": {"python": "skip", "docker": "auto", "docs": "force"},
            "notes": "File notes",
        }
        workflow_inputs = {
            "level": "major",
...
class TestValidateIntent:
    ...
    def test_valid_intent(self) -> None:
        ...
        valid_intent = {
            "release": True,
            "level": "minor",
            "artifacts": {"python": "auto", "docker": "force", "docs": "skip"},
            "notes": "Test release",
        }
    ...
    def test_invalid_intent_validation_error(self) -> None:
        ...
        invalid_intent = {"release": "not_a_boolean", "level": "invalid_level"}  # Invalid type  # Invalid enum value
    ...
    def test_invalid_schema_error(self) -> None:
        ...
        invalid_schema = {"$schema": "invalid_schema_url", "type": "invalid_type"}
...
class TestWriteGithubOutputs:
    ...
    def test_write_outputs_with_false_release(self) -> None:
        ...
        intent = {
            "release": False,
            "level": "auto",
            "artifacts": {"python": "skip", "docker": "skip", "docs": "skip"},
            "notes": "",
        }
...
class TestEndToEndIntegration:
    ...
    def test_workflow_without_intent_file(self) -> None:
        ...
        schema_content = {
            "$schema": "https://json-schema.org/draft/2020-12/schema",
            "type": "object",
            "properties": {"release": {"type": "boolean"}},
        }
