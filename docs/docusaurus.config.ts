...
const config: Config = {
  ...
  baseUrl: '/GitHub-Action_Reusable_Workflows-Python/',
  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl:
          'https://github.com/Chisanan232/GitHub-Action_Reusable_Workflows-Python/tree/master/docs/',
        versions: {
          current: {
            label: 'Next',
            path: 'next',
    ...
    [
      require.resolve('@easyops-cn/docusaurus-search-local'),
      {
        ...
        hashed: true,
        language: ['en'],
        docsRouteBasePath: ['/GitHub-Action_Reusable_Workflows-Python'],
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/Chisanan232/GitHub-Action_Reusable_Workflows-Python/issues',
            },
            {
              label: 'GitHub Discussions',
              href: 'https://github.com/Chisanan232/GitHub-Action_Reusable_Workflows-Python/discussions',
            },
          ],
        },
        {
      ...
      copyright: `Copyright ${new Date().getFullYear()} - PRESENT, GitHub Action Reusable Workflows is owned by <a href="https://github.com/Chisanan232">@Chisanan232</a>.<br />Built with <a href="https://docusaurus.io/">Docusaurus</a>.`,
    },
    prism: {
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'canonical',
        href: 'https://chisanan232.github.io/GitHub-Action_Reusable_Workflows-Python/docs/introduction',
      },
    },
  ],
};
