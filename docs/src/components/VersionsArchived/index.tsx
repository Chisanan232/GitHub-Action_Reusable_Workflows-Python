...
export default function VersionsArchived(): JSX.Element {
  ...
  const releaseBaseUrl = 'https://github.com/Chisanan232/GitHub-Action_Reusable_Workflows-Python/releases/tag/v';
            ...
            <div className={styles.versionSection}>
              ...
              <div className={styles.versionRow}>
                ...
                <div className={styles.versionLinks}>
                  ...
                  <Link
                    className={`${styles.versionLink} ${styles.releaseNotesLink}`}
                    to="https://github.com/Chisanan232/GitHub-Action_Reusable_Workflows-Python/commits/master"
                    target="_blank"
                    rel="noopener noreferrer">
                    <Translate
